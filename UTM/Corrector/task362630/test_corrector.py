...
@pytest.mark.parametrize('orderID, serviceId, typeDoc, fsrar, inn, kpp, branch', [
    (result, 'corrector-epgu', 'Сведения о поставке', '', '7714698320', '271744622', 'МРУ Росалкогольрегулирования по ЦФО')
])
...
@pytest.mark.parametrize('orderID, serviceId, typeDoc, fsrar, inn, kpp, branch', [
    (result, 'corrector-epgu', 'Сведения о поставке', '111111111111', '7714698320', '271744622', 'МРУ Росалкогольрегулирования по ЦФО')
])
